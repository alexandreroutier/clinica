...
class DwiPreprocessingUsingOnlyEddyCli(ce.CmdParser):

    def define_name(self):
        """Define the sub-command name to run this pipeline."""
        self._name = 'dwi-preprocessing-using-only-eddy'

    def define_description(self):
        """Define a description of this pipeline."""
        self._description = ('Preprocessing of raw DWI datasets using only eddy')
    ...
    def run_command(self, args):
        ...
        from .dwi_preprocessing_using_only_eddy_pipeline import DwiPreprocessingUsingOnlyEddy
        ...
        pipeline = DwiPreprocessingUsingOnlyEddy(
